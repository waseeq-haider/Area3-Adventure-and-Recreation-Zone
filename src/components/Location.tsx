...
const locationDetails = [
  {
    icon: MapPin,
    title: "Adjacent to Area 2",
    description: "Student Accommodation"
  },
  {
    icon: Route,
    title: "Connected by Trails",
    description: "To Areas 1 (Dining & Events) and 4 (Eco Lodges)"
  },
  {
    icon: TreePine,
    title: "RANGERS OVERLAY Zone",
    description: "Partially within protected natural area"
  }
];
